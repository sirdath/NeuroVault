...
#
# Policy comes from env var `NEUROVAULT_HOOKS_POSTTOOLUSE`:
...
_POSTTOOLUSE_MODE = (
    _env("NEUROVAULT_HOOKS_POSTTOOLUSE", "ENGRAM_HOOKS_POSTTOOLUSE", "mutations") or "mutations"
).lower().strip()
...
def capture_observation(
    ...
    # NEUROVAULT_HOOKS_POSTTOOLUSE (default "mutations"). See module top.
    if event == "PostToolUse":
    ...
    if event == "UserPromptSubmit" and engram_id:
        try:
            from neurovault_server.insight_extractor import promote_insights_from_text
